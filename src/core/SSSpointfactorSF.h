...
#ifndef SSSPOINTFACTORSF_H
#define SSSPOINTFACTORSF_H
...
using namespace std;
    ...
    class SssPointFactorSF: public gtsam::NoiseModelFactor2<gtsam::Point3, gtsam::Pose3>
    {
         ...
         */
        SssPointFactorSF(gtsam::Key pointKey, gtsam::Key poseKey, const gtsam::Point2 &m, const gtsam::Pose3 &Ts, const gtsam::Pose3 &Tp, gtsam::SharedNoiseModel model) :
            gtsam::NoiseModelFactor2<gtsam::Point3, gtsam::Pose3>(model, pointKey, poseKey), mx_(m.x()), my_(m.y()), Ts_(Ts), Tp_(Tp) {}
