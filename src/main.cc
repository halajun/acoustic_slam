...
int main(int argc, char** argv)
{
    ...
    while (iter_num<max_iter)
    {
        ...
        // if (iter_num==1 && KPS_TYPE==2)
        // {
        //   // --- save point clouds generated by dr pose and dense matches  --- //
        //   string path = "../raw_pointclouds.csv";
        //   Optimizer::SaveDensePointClouds(test_frames, path);
